...
//chyba wszystko jest na tyle proste, że da się te warunki zawrzeć w ifach
    ...
    //
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//TODO wprowadzić wzory na kompensację SBE
    //TODO przemyśleć to całe AG w SBE. Czy nie trzeba by było BExa? a jeśli tak, to czemu od razu i nie Stewart?

    static String metodaNadrzednaSbe (double ph, double sbe, double paco2, double hco3, double ag){
        if(ph < 7.36){
            return kwasicaSbe (sbe, hco3, paco2, ag);

        }
        else if(ph > 7.44){
            return zasadowicaSbe (sbe, hco3, paco2, ag);
        }

        else{
            return normatywneSbe (sbe, hco3, paco2, ag);
        }
    ...
    static double dajSbeGapRatio (double ag, double hco3){
        if (ag == 7 && hco3 == 24){
            return 1;
        }
        else if ( hco3 == 24){
    ...
    static String kwasicaSbe (double hco3, double sbe, double paco2, double ag){
        double przewidywanePaco2 = dajPrzewidywanePaco2(hco3);
        double gapGapRatio = dajGapGapRatio(ag, hco3);
        double szacowaneHco3KwOddOstra = dajSzacowaneHco3KwOddOstra (paco2);
        double szacowaneHco3KwOddPrzewlA = dajSzacowaneHco3KwOddPrzewlA (paco2);
    ...
    static String zasadowicaSbe (double sbe, double hco3, double paco2, double ag) {
        double przewidywanePaco2Zasadowe = dajPrzewidywanePaco2Zasadowe(hco3);
        double gapGapRatio = dajGapGapRatio(ag, hco3);
        double szacowaneHco3ZasOddOstra = dajSzacowaneHco3ZasOddOstra (paco2);
        double szacowaneHco3ZasOddPrzewlA = dajSzacowaneHco3ZasOddPrzewlA (paco2);
    ...
    static String normatywneSbe (double sbe, double hco3, double paco2, double ag) {
        double gapGapRatio = dajGapGapRatio(ag, hco3);
